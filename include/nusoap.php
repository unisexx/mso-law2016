...
class nusoap_base {
	...
	* @access   public
	*/
    //var $soap_defencoding = 'TIS-620'; //'ISO-8859-1';
...
class soap_server extends nusoap_base {
	...
	var $request = '';
	/**
	 * SOAP headers from request (incomplete namespace committee; special characters not escaped) (text)
	 * @var string
	 * @access public
	 */
	var $requestHeaders = '';
	/**
	 * SOAP body request portion (incomplete namespace committee; special characters not escaped) (text)
	 * @var string
	 * @access public
	 */
	var $document = '';
	...
	*/
	function soap_parser($xml,$encoding='UTF-8',$method='',$decode_utf8=true){
		...
		if(!empty($xml)){
            ...
            // View Parser
            //echo "this->parser : $this->parser<br>";
            //echo "xml : $xml<br>";
...
class soapclientx extends nusoap_base  {
	...
	var $responseHeaders = '';		// SOAP headers from response (incomplete namespace committee) (text)
	var $document = '';				// SOAP body response portion (incomplete namespace committee) (text)
	var $endpoint;
	...
	* @access   public
	*/
	function soapclientx($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	/**
	* get the SOAP response headers (namespace committee incomplete)
	*
	* @return	string
	* @access   public
	*/
