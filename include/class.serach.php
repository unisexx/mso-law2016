                 ...
                 while($value = $this->db->fetch_array($result)){
                   ...
                   // นับจำนวนครั้ง Download
                    ...
                    if($valueData['filename_eng']!=""){
                        ...
                        $txtDownloadEN = '<a href="law/download_by_name/'.$valueData['id'].'?filename='.$valueData['filename_eng'].'" target="_blank"><img src="themes/law/images/icon-pdf.png" width="16" height="16" class="icon-hover"><br> ('.$counte.' Downloads)</a>';
                        /*
                      ...
                      */
                        ...
                        $txtDownloadTH = '<a href="law/download_by_name/'.$valueData['id'].'?filename='.$valueData['filename_th'].'" target="_blank"><img src="themes/law/images/icon-pdf.png" width="16" height="16" class="icon-hover"><br> ('.$count.' ครั้ง)</a>';
