...
<tr>
  ...
  <td><span class="form-inline"><input name="textarea7" type="text" class="form-control" placeholder="ชื่อผู้ใช้งาน" id="textarea7" value="" style="width:250px;"/> / <input name="textarea7" type="text" class="form-control" placeholder="นามสกุลผู้ใช้งาน" id="textarea7" value="" style="width:350px;"/></span></td>
</tr>
<tr>
  <th>ตำแหน่ง</th>
  <td>
