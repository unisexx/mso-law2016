...
<form class="form-inline">
  <div class="col-xs-4">
    <input type="text" class="form-control " id="exampleInputName2" placeholder="ชื่อกลุ่มกฎหมาย">
  </div>
...
<div id="btnBox">
  <input type="button" title="เพิ่มกลุ่มกฎหมาย" value="เพิ่มกลุ่มกฎหมาย" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'" class="btn btn-warning vtip" />
</div>
...
<tr class="odd">
  <td>2</td>
  <td><a href="#">กฎหมายประกอบภารกิจ</a></td>
  <td>74</td>
