...
if ( ! function_exists('mysql_to_en'))
{
	function mysql_to_en($datetime = '',$format = 'S' ,$time = FALSE)
	{
		if($datetime == '0000-00-00' || $datetime=='')return false;
		if($format == 'F')
		{
			$month_th = array( 1 =>'JAN',2 => 'FEB',3=>'MAR',4=>'APR',5=>'MAY',6=>'JUN',7=>'JUL',8=>'AUG',9=>'SEP',10=>'OCT',11=>'NOV',12=>'DEC');
		}
		else
		{
			$month_th = array( 1 =>'JAN',2 => 'FEB',3=>'MAR',4=>'APR',5=>'MAY',6=>'JUN',7=>'JUL',8=>'AUG',9=>'SEP',10=>'OCT',11=>'NOV',12=>'DEC');
		...
		$r = date('d', $datetime).' '.$month_th[date('n', $datetime)].' '.(date('Y', $datetime));
